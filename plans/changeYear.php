...
?>
	...
	<div class="main-content-wrapper">
		...
		<div>
			<form action="../controllers/updateYear.php?ref=<?php echo $ref ?>" method="post">
				<div class="styled-select"><label>Select year: </label>
	                <select name="year">      
	           	...
	           	<input type="submit" name="updateYear" class="formButton" />
            </form>
		</div>
